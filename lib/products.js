...
export const PRODUCTS = [
  ...
  { emoji: '🥼', name: 'Polo manches longues', photo: '/produits/polo-manches-longues/marine.jpg', price: 2700,
    desc: 'Piqué coton 220g/m² manches longues. Col côtelé, poignets finis. Confort toute saison.',
    techniques: ['Broderie','Sérigraphie','Transfert'],
    variants: [
      { name: 'Marine',         hex: '#1A1F30', photo: '/produits/polo-manches-longues/marine.jpg' },
      { name: 'Noir',           hex: '#191918', photo: '/produits/polo-manches-longues/noir.jpg' },
      { name: 'Blanc',          hex: '#EEEEF7', photo: '/produits/polo-manches-longues/blanc.jpg' },
      { name: 'Gris',           hex: '#A2A3A7', photo: '/produits/polo-manches-longues/gris.jpg' },
      { name: 'Bleu roi',       hex: '#0A3EA8', photo: '/produits/polo-manches-longues/bleu.jpg' },
      { name: 'Vert bouteille', hex: '#19452C', photo: '/produits/polo-manches-longues/vert.jpg' },
      { name: 'Rouge',          hex: '#CA021B', photo: '/produits/polo-manches-longues/rouge.jpg' },
      { name: 'Jaune',          hex: '#FBD632', photo: '/produits/polo-manches-longues/jaune.jpg' },
      { name: 'Orange',         hex: '#FA6212', photo: '/produits/polo-manches-longues/orange.jpg' },
    ] },
  { emoji: '👕', name: 'T-shirt', photo: '/produits/tshirt/noir.jpg', price: 1950,
    desc: 'Coton 180g/m². Col rond renforcé, coupe droite. Idéal pour équipes et événements.',
    techniques: ['Sérigraphie','Transfert','Sublimation'],
    variants: [
      { name: 'Noir',           hex: '#2F2523', photo: '/produits/tshirt/noir.jpg' },
      // Seule teinte non relevée sur la photo : ce t-shirt est pris devant un
      // fond rose qui lui donne un reflet, et la pastille doit rester blanche.
      { name: 'Blanc',          hex: '#F2F0EE', photo: '/produits/tshirt/blanc.jpg' },
      { name: 'Marine',         hex: '#37394E', photo: '/produits/tshirt/marine.jpg' },
      { name: 'Gris',           hex: '#B7B3AD', photo: '/produits/tshirt/gris.jpg' },
      { name: 'Anthracite',     hex: '#4B4B4B', photo: '/produits/tshirt/anthracite.jpg' },
      { name: 'Bleu roi',       hex: '#3F51AB', photo: '/produits/tshirt/bleu.jpg' },
      { name: 'Vert bouteille', hex: '#304D32', photo: '/produits/tshirt/vert.jpg' },
      { name: 'Rouge',          hex: '#FC1B23', photo: '/produits/tshirt/rouge.jpg' },
      { name: 'Jaune',          hex: '#FCC303', photo: '/produits/tshirt/jaune.jpg' },
    ] },
