...
export const PRODUCTS = [
  ...
  { emoji: '🥼', name: 'Polo manches longues', price: 1450, desc: 'Piqué coton 220g/m² manches longues. Confort toute saison.', techniques: ['Broderie','Sérigraphie','Transfert'] },
  ...
  { emoji: '🧶', name: 'Sweat', price: 2400, desc: 'Molleton gratté 280g/m². Col rond, poignets côtelés.', techniques: ['Broderie','Sérigraphie','Flocage'], popular: true },
