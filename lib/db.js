...
// Exported so the atelier's task helpers (lib/atelier/db.js) reach Supabase
// through this same guarded path rather than opening a second one with its
// own copy of the key handling.
