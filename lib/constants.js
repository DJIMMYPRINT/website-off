...
export const ORDER_STAGES = [
  // The timeline numbers its own steps — an emoji per stage read as
  // decoration on what is a status record.
  { key: 'recue',     label: 'Commande reçue', desc: 'Votre demande nous est parvenue sur WhatsApp.' },
  { key: 'confirmee', label: 'Devis confirmé', desc: 'Quantités, technique et prix validés avec vous.' },
  { key: 'production',label: 'En production',  desc: 'Marquage en cours dans notre atelier.' },
  { key: 'expediee',  label: 'Expédiée',       desc: 'Remise au transporteur vers votre wilaya.' },
  { key: 'livree',    label: 'Livrée',         desc: 'Commande réceptionnée. Merci de votre confiance !' },
]
...
// Argument commun à toute la gamme, formulé par le gérant. Volontairement
// factuel : pas de superlatif du type « meilleure qualité du marché », qui
// engagerait l'entreprise sur une comparaison invérifiable.
export const PRODUCT_PITCH = 'Confortables pour le travail, pratiques et durables.'
