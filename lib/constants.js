...
// Machine-readable version of HOURS above, for the auto-reply bot: it needs
// to know whether the workshop is open *right now* to promise a human
// follow-up honestly. Keys are JS getDay() values (0 = dimanche), each value
// is [heure d'ouverture, heure de fermeture] or null when closed.
// Samedi is "sur RDV" — treated as closed for the bot, since nobody is
// guaranteed to be at the phone.
...
// Algeria is UTC+1 all year (no daylight saving), so a fixed offset is
// correct here and avoids depending on the server's timezone — Vercel runs
// in UTC.
export const TZ_OFFSET_HOURS = 1
