...
import { WA, PHONE_DISPLAY, EMAIL, ADDRESS, SITE_URL, MIN_ORDER, HOURS, TECHNIQUES } from './constants'
...
export const RULES = [
  ...
  },
  {
    ...
    keywords: [
      'broderie', 'brodee', 'serigraphie', 'sublimation', 'transfert', 'flocage', 'flex',
...
export function matchRule(message) {
  ...
  for (const rule of RULES) {
    ...
    let score = hits(text, rule.keywords)
